---
title: "Nano Banana（Gemini 图像）"
description: "Google Gemini 内嵌的图像生成与编辑模型，擅长对话式修改和角色一致性。"
...
- 多轮对话式局部编辑
- 多图融合和主体一致性
- 通过 Google AI Studio 进行开发测试

## 价格与访问
Google 产品通常提供有限免费使用，API 按模型和调用量计费。可用地区与额度以官方页面为准。

## 适用人群
需要连续迭代视觉方案、制作角色素材或把图像能力接入应用的创作者和开发者。
